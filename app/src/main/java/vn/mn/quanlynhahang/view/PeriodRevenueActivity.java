...
public class PeriodRevenueActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(PeriodRevenueActivity.this, "Ngày được chọn: " + selectedDate, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void showDatePicker(final Calendar date) {
        ...
        new DatePickerDialog(PeriodRevenueActivity.this, dateSetListener, date.get(Calendar.YEAR),
    ...
    private void calculateAndDisplayRevenue(Calendar startDate, Calendar endDate) {
        ...
        databaseReference.child("order").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                RevenueAdapter adapter = new RevenueAdapter(PeriodRevenueActivity.this, revenueList);
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(PeriodRevenueActivity.this, "Lỗi khi truy vấn dữ liệu từ Firebase", Toast.LENGTH_SHORT).show();
            }
        });
    }
